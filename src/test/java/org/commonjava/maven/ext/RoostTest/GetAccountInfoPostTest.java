...
public class GetAccountInfoPostTest {
    ...
    public void GetAccountInfo_post_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "org" + File.separator + "commonjava" + File.separator + "maven" + File.separator + "ext" + File.separator + "RoostTest" + File.separator + "GetAccountInfoPostTest.csv"))) {  
