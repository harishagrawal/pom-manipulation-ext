    ...
    public void accountsGet_Test() {  
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "org" + File.separator + "commonjava" + File.separator + "maven" + File.separator + "ext" + File.separator + "RoostTest" + File.separator + "accountsGetTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
              ...
              if (response.jsonPath().get("accounts["+ i +"]._links.type") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("accounts["+ i +"]._links.type"), instanceOf(undefined.class));  
          }
    
              if (response.jsonPath().get("accounts["+ i +"]._links.properties") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("accounts["+ i +"]._links.properties"), instanceOf(undefined.class));  
          }
...
if (response.statusCode() == 400) {
              ...
              if (response.jsonPath().get("_links.type") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("_links.type"), instanceOf(undefined.class));  
          }
    
              if (response.jsonPath().get("_links.properties") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("_links.properties"), instanceOf(undefined.class));  
          }
