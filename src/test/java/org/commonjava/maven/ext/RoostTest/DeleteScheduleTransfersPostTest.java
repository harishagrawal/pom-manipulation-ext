...
public class DeleteScheduleTransfersPostTest {
    ...
    public void DeleteScheduleTransfers_post_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/org/commonjava/maven/ext/RoostTest/DeleteScheduleTransfers_post.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
				...
				.body("{\n"+
					...
					"  \"updateTransferType\": \"" + map.get("updateTransferType") + "\",\n" +
