...
public class validatePINPostTest {
    ...
    public void validatePIN_post_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/org/commonjava/maven/ext/RoostTest/validatePIN_post.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
				...
				.body("{\n"+
					"  \"sourcePin\": \"" + map.get("sourcePin") + "\",\n" +
					"  \"targetPin\": \"" + map.get("targetPin") + "\",\n" +
					"  \"profileInfo\": \"" + map.get("profileInfo") + "\n" +
 				"}")
                .when()
                .post("/validatePIN")  
                .then() 
